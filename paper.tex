...
(an issue we might address by using transactions as discussed in \S\ref{sec:discuss-future}).
...
(see \S\ref{sec:discuss-future}). Effects describe how an edit affects the document structure
...
TODO: SHould it transform document structure?
