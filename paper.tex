...
identify a common shared part of the history during conflict checking and merging.
...
edits, in the above sense, can be reconcilliated.

If the edits in $E_1$ and $E_2$ conflict,
...
The design the Denicek substrate, we identified five formative examples shown in
Fig.~\ref{fig:examples}. The examples range from established industry benchmarks
(Todo and Counter apps) to problems posed as schema change challenges \cite{edwards-2025-schema}.
