...
We contribute Denicek, a system that reduces the complexity of
...
We show how these three operations can be composed to implement a range of
programming experiences.
We call Denicek a \emph{computational substrate} because it serves as a shared platform for such varied programming experiences.
...
A computational substrate defines the basic structures with which programs are constructed, how
...
provided by the substrate can reduce the complexity of implementing interesting
...
In this paper, we aim to design a programming substrate that makes it easier to develop a range of
rich, interactive programming experiences \cite{myers-2006-eup}:
