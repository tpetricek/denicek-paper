...
Denicek is intended as a low-level computational substrate that can be used as the basis for
interactive programming systems that view programs as documents. The most prominent example
of such systems today are notebook environments for data science. We developed Datnicek, a
simple notebook system that shows the ability of Denicek to support rich interactive user
...
\item \emph{Structure Editing.} Code in code cells should be edited through structure editor
  ...
  We do not aim to implement advanced keyboard-based editing \cite{moon-2022-tylr,beckman-2023-sandblocks}.
...
\item \emph{Wrangling Code Synthesis.} Interactively constructed data transformations should be
  turned into code that can be checked and further edited as in Wrex \cite{drossos-2020-wrex}.
\end{itemize}
