...
\begin{abstract}
Human-computer interaction research gave rise to a wide range of compelling programming experiences,
...
implement on the basis of established programming languages and systems.
...
primitive operations on series of edits, application, merging of histories and conflict checking.
We show that the three operations form the backbone of an easy implementation of a range of
...
We use a two-stage research methodology. In the first stage, we identify a number
of \emph{formative examples} -- simple programming tasks, drawn from literature, that manifest one or
more of the desired programming experiences. Using those examples, we co-design the Denicek substrate
and Webnicek (Section~\ref{sec:walk}), a simple web-based end-user programming environment based on the substrate.
Although Webnicek can be used to complete end-user programming tasks, it is optimized for
testing the underlying substrate rather than for usability.

In the second stage, we use the Denicek substrate as the basis of Datnicek, an end-user data
exploration environment inspired by existing research systems\cite{kandel-2011-wrangler,drossos-2020-wrex}.
...
% debugging
% https://dl.acm.org/doi/pdf/10.1145/1133265.1133293
...
METHODOLOGY (add somewhere belo) - table of "formative examples" and experiences they require?
+ SOURCE (literature?)
...
what is this about?
end-user programming ? Cite % https://dl.acm.org/doi/pdf/10.1145/1125451.1125472
but also Live, Interactive etc. - perhaps for a lack of better term use end-user
(also notebooks)
