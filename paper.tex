...
reference to a sequence of edits recorded in the document. Clicking the button executes the edits
...
% TODO: In implementation use effects to better replay recorded edits
...
alternative approache is discussed in \S\ref{sec:discuss}
